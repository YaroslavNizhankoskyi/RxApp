        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedAddingRecipes = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    MedicId = table.Column<string>(type: "text", nullable: true),
                    PatientId = table.Column<string>(type: "text", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    IsDeletedForMedic = table.Column<bool>(type: "boolean", nullable: false),
                    IsDeletedForPatient = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PharmGroupId = table.Column<int>(type: "integer", nullable: true),
                    NameRus = table.Column<string>(type: "text", nullable: true),
                    NameEng = table.Column<string>(type: "text", nullable: true),
                    Action = table.Column<string>(type: "text", nullable: true),
                    Dosing = table.Column<string>(type: "text", nullable: true),
                    Overdose = table.Column<string>(type: "text", nullable: true),
                    StorageCondition = table.Column<string>(type: "text", nullable: true),
                    Nozology = table.Column<string>(type: "text", nullable: true),
                    Packaging = table.Column<string>(type: "text", nullable: true),
                    Indications = table.Column<string>(type: "text", nullable: true),
                    BestBefore = table.Column<string>(type: "text", nullable: true),
                    SpecialCases = table.Column<string>(type: "text", nullable: true),
                    SideEffects = table.Column<string>(type: "text", nullable: true),
                    DuringPregnancy = table.Column<string>(type: "text", nullable: true),
                    Pharmacodynamics = table.Column<string>(type: "text", nullable: true),
                    Pharmacokinetics = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
