        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedAddingRecipes = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeletedForMedic = table.Column<bool>(type: "bit", nullable: false),
                    IsDeletedForPatient = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Recipes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Recipes_AspNetUsers_MedicId",
                        column: x => x.MedicId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PharmGroupId = table.Column<int>(type: "int", nullable: true),
                    ...
                    Dosing = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Nozology = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    BestBefore = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SpecialCases = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SideEffects = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DuringPregnancy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Pharmacodynamics = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Pharmacokinetics = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrugActiveIngredients", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeDrugs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DrugActiveIngredients_DrugId",
                table: "DrugActiveIngredients",
                column: "DrugId");
